    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      <FadeIn>
        ...
        <p className="max-w-2xl mx-auto text-lg md:text-xl text-slate-600 mb-10 leading-relaxed">
          Safe, private, and judgment-free emotional support whenever you need it. 
          Your journey to mental wellness starts with a single, small step.
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link href="/login" className="w-full sm:w-auto px-8 py-4 bg-indigo-600 text-white rounded-2xl font-semibold hover:bg-indigo-700 transition-all shadow-lg hover:shadow-indigo-200/50 flex items-center justify-center gap-2">
            Start Anonymously <ArrowRight size={18} />
          </Link>
          <Link href="/login" className="w-full sm:w-auto px-8 py-4 bg-white text-slate-700 border border-slate-200 rounded-2xl font-semibold hover:bg-slate-50 transition-all">
            Explore Resources
          </Link>
        </div>
      </FadeIn>
      ...
      <div className="mt-16 relative mx-auto max-w-3xl">
            ...
            <div className="text-left">
              <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Active wellness</p>
              <p className="text-sm font-black text-slate-800">Mindful Morning</p>
            </div>
          </div>
