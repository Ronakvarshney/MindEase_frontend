      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 bg-[#043d43] border border-gray-700 rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="p-6 space-y-4">
            ...
            {/* Participate Button with shadcn/ui Dialog */}
            <Dialog>
              <DialogTrigger asChild>
                <button className="w-full mt-6 bg-green-600 hover:bg-green-700 text-white py-3 px-6 font-medium rounded-xl shadow-md transition">
              ...
              <DialogContent className="sm:max-w-lg">
                ...
                <DialogFooter className="mt-4 flex justify-end gap-3">
                  <DialogClose asChild>
                    <button className="bg-gray-200 text-gray-900 px-4 py-2 rounded-md hover:bg-gray-300 transition">
                      Cancel
                    </button>
                  </DialogClose>
