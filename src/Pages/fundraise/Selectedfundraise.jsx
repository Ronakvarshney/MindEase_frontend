        ...
        <div className="flex-1 bg-[#043d43] border border-gray-700 rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4 mt-4">
              ...
              <div>
                <h2 className="text-lg font-semibold text-gray-200">Time</h2>
            ...
            <Dialog>
              <DialogTrigger>
                <button className="w-full mt-6 bg-green-600 hover:bg-green-700 text-white py-3 font-medium rounded-xl shadow-md transition">
        ...
        <div className="flex-1 flex flex-col gap-6">
          <div className="bg-[#043d43] rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition duration-300 ease-in-out">
            ...
            <div className="p-6 text-center">
              ...
              <Dialog>
                <DialogTrigger>
                  <div className="bg-gradient-to-r from-pink-500 to-red-500 px-6 py-3 rounded-md font-semibold text-white shadow-md hover:scale-105 transform transition duration-300">
                    Donate
                  </div>
                </DialogTrigger>
                <DialogContent>
